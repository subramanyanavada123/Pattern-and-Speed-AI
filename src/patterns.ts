  ...
  },
  {
    ...
    scenarios: [
      { id: 'gym-normal', patternId: 'gym', kind: 'normal', title: 'Late lab, bag not staged',
        ...
        clockMin: 18 * 60 + 10, dayOfWeek: 3, flags: { labRanLate: true, bagPacked: false, alreadyTrainedToday: false }, expectedFire: true, fromMistral: false },
      { id: 'gym-edge', patternId: 'gym', kind: 'edge', title: 'Late lab, but bag already staged',
        ...
        clockMin: 18 * 60 + 10, dayOfWeek: 3, flags: { labRanLate: true, bagPacked: true, alreadyTrainedToday: false }, expectedFire: false, fromMistral: false },
      { id: 'gym-exception', patternId: 'gym', kind: 'exception', title: 'Already trained this morning',
        ...
        clockMin: 18 * 60 + 10, dayOfWeek: 3, flags: { labRanLate: true, bagPacked: false, alreadyTrainedToday: true }, expectedFire: false, fromMistral: false },
      { id: 'gym-stress', patternId: 'gym', kind: 'stress', title: 'On time day, bag not staged',
        ...
        clockMin: 18 * 60 + 10, dayOfWeek: 3, flags: { labRanLate: false, bagPacked: false, alreadyTrainedToday: false }, expectedFire: false, fromMistral: false },
    ],
  },
  {
